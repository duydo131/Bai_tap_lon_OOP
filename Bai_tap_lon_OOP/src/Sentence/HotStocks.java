...
public static long totalVolume(STOCK stock, Date date1, Date date2) {
		
		long total = 0;;
		
		int days = date2.getDate() - date1.getDate();
	...
	public static STOCK[] selectionSorting(STOCK[] stock, Date date1, Date date2) {
		int max;
		STOCK temp;
